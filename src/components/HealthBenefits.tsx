...
const benefits = [
  {
    ...
    desc: 'Copper naturally kills 99.9% of bacteria, fungi, and viruses within hours. Water stored in copper for 8+ hours becomes naturally purified.'
  },
  {
    icon: '⚗️',
    title: 'Ayurvedic Wisdom',
    desc: 'Ancient Ayurvedic texts (Charaka Samhita) call copper "Tamra Jal" — a remedy for digestive disorders, joint inflammation, and improved metabolism.'
  },
  {
    icon: '🧠',
    title: 'Brain & Nerve Health',
    desc: 'Copper aids in the synthesis of phospholipids, essential for myelin sheaths that protect nerve cells and support cognitive function.'
  },
  {
    icon: '❤️',
    title: 'Heart & Circulation',
    desc: 'Copper regulates blood pressure, reduces bad cholesterol, and supports the formation of haemoglobin — keeping your heart strong and blood pure.'
  },
  {
    icon: '🦴',
    title: 'Bones & Joints',
    desc: 'Copper is essential for the formation of collagen and connective tissue. Regular use supports strong bones and reduces arthritis pain.'
  },
  {
    icon: '✨',
    title: 'Skin & Anti-Aging',
    desc: 'Copper stimulates the production of melanin and collagen — the skin\'s building blocks. Ancient queens stored their skin tonics in copper vessels.'
  },
];
