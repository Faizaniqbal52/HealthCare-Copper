...
const products = [
  {
    ...
    badge: 'Bestseller',
    image: '/product-samovar-classic.png',
  },
  {
    id: 'samovar-royal',
    name: 'Royal Buta Samovar',
    category: 'Samovar & Tea',
    tagline: 'For those who honour tradition in every cup',
    desc: 'A wider, grander Samovar with full-body Paisley (Buta) and floral vine Kandkari engraving. The signature piece of a Kashmiri home. Antique copper patina.',
    badge: 'Heritage',
    image: '/product-samovar-royal.png',
  },
  {
  ...
  {
    id: 'bottle-engraved',
    name: 'Kandkari Engraved Drinkware Set',
    category: 'Bottles & Drinkware',
    tagline: 'A piece of art you carry',
    desc: 'Our signature engraved bottle (800ml), traditional Khos cups with saucers, and a copper pitcher — all hand-engraved with Paisley and Chinar motifs.',
    badge: 'Artisan',
    image: '/product-drinking-ware.png',
  },
  {
    id: 'traam-large',
    name: 'Wazwan Traam Platter Collection',
    category: 'Traam & Platters',
    tagline: 'For feasts worthy of the Valley',
    desc: 'Ceremonial copper platters used in traditional Kashmiri Wazwan feasts. Hand-hammered surface, ornate Chinar and Paisley border engraving. Multiple sizes available.',
    badge: 'Heritage',
    image: '/product-trayam.png',
  },
  {
    id: 'chai-set',
    name: 'Noon Chai Cup Set (6 pcs)',
    category: 'Samovar & Tea',
    tagline: 'Every sip, a Kashmiri memory',
    desc: 'Set of 6 small copper Khos cups with saucers, hand-engraved Kashida floral borders. Perfect companion to any Samovar. Tin-lined interior for safe daily use.',
    badge: 'Gift Set',
    image: '/product-chai-set.png',
  },
  {
    id: 'vase-decorative',
